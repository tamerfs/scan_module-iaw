...
{
	// Token: 0x060003E8 RID: 1000 RVA: 0x000033F5 File Offset: 0x000015F5
	public GClass98()
	{
		this.method_0();
		this.method_2();
	...
	// Token: 0x060003E9 RID: 1001 RVA: 0x00003409 File Offset: 0x00001609
	public GClass98(string string_0)
	{
		this.method_0();
		this.method_1(string_0);
	}

	// Token: 0x060003EA RID: 1002 RVA: 0x0006787C File Offset: 0x00065A7C
	...
	// Token: 0x060003EB RID: 1003 RVA: 0x0006795C File Offset: 0x00065B5C
	private void method_1(string string_0)
	{
		...
		for (int i = 0; i < GClass127.smethod_51().Length; i++)
		{
			...
			if (num != 3 && (num != 2 || num > 3) && num != 1 && !GClass127.smethod_51()[i].StartsWith("lang0"))
			{
				...
				while (fileStream.Position < fileStream.Length)
				{
					...
					byte[] array9 = array;
					int num10 = 4;
					array9[num10] ^= array[1];
					byte[] array10 = array;
					int num11 = 11;
					array10[num11] ^= array[10];
					byte[] array11 = array;
					int num12 = 8;
					array11[num12] ^= array[9];
					byte[] array12 = array;
					int num13 = 5;
					array12[num13] ^= array[8];
					byte[] array13 = array;
					int num14 = 3;
					array13[num14] ^= array[1];
					byte[] array14 = array;
					int num15 = 3;
					array14[num15] ^= array[0];
					int num16 = (int)array[3] + 256 * (int)array[2];
					int num17 = (int)array[6] + 256 * (int)array[10];
					int num18 = (int)array[1] + 256 * (int)array[7];
					int num19 = (int)array[11] + 256 * (int)array[5];
					int num20 = (int)array[9] + 256 * (int)array[4];
					int num21 = (int)array[13] + 256 * (int)array[12];
					byte[] array15 = new byte[num16];
					byte[] array16 = new byte[num17];
					byte[] array17 = new byte[num18];
					byte[] array18 = new byte[num19];
					byte[] array19 = new byte[num20];
					byte[] array20 = new byte[num21];
					fileStream.Read(array15, 0, array15.Length);
					array15 = GClass103.smethod_0(array15);
					fileStream.Read(array16, 0, array16.Length);
					fileStream.Read(array17, 0, array17.Length);
					fileStream.Read(array18, 0, array18.Length);
					fileStream.Read(array19, 0, array19.Length);
					fileStream.Read(array20, 0, array20.Length);
					bool bool_ = string_0 != Encoding.Unicode.GetString(array15) && Encoding.Unicode.GetString(array15) != "ZZGEN";
					array16 = GClass103.smethod_1(array16, bool_);
					array17 = GClass103.smethod_1(array17, bool_);
					array18 = GClass103.smethod_1(array18, bool_);
					array19 = GClass103.smethod_1(array19, bool_);
					array20 = GClass103.smethod_1(array20, bool_);
					if (array16 != null)
					{
						this.dataTable_0.Rows.Add(new object[]
						{
							...
							Encoding.Unicode.GetString(array17),
							Encoding.Unicode.GetString(array18),
							GClass127.smethod_37(Encoding.Unicode.GetString(array19)),
							GClass127.smethod_37(Encoding.Unicode.GetString(array20))
						});
					}
				}
				fileStream.Close();
	...
	// Token: 0x060003EC RID: 1004 RVA: 0x00067D0C File Offset: 0x00065F0C
