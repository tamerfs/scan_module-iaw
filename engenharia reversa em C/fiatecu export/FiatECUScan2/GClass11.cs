...
public sealed class GClass11 : GClass4
{
	// Token: 0x060004DC RID: 1244 RVA: 0x0008FDB0 File Offset: 0x0008DFB0
	public GClass11(byte byte_7, string string_6, List<GClass58> list_3, List<GClass58> list_4)
	{
	...
	// Token: 0x060004DD RID: 1245 RVA: 0x0008FE6C File Offset: 0x0008E06C
		...
		try
		{
			...
			if (GClass3.bool_0)
			{
				...
				for (int i = 0; i < this.list_1.Count; i++)
				{
					...
					{
						text = this.vmethod_6(array2[0], gclass.string_2, gclass.int_0, gclass.int_1, gclass.string_5, gclass.string_6);
					}
					else if (GClass16.smethod_1(gclass.byte_0[0]) == "03 22 40 A2")
					{
						text = this.vmethod_6(array2[1], gclass.string_2, gclass.int_0, gclass.int_1, gclass.string_5, gclass.string_6);
					}
					else if (GClass16.smethod_1(gclass.byte_0[0]) == "03 22 20 23")
					{
						text = this.vmethod_6(array2[2], gclass.string_2, gclass.int_0, gclass.int_1, gclass.string_5, gclass.string_6);
					}
			...
			try
			{
				...
				if (GClass61.smethod_36() == 4)
				{
					...
					this.method_39("ATBRD16");
					string text3 = string.Concat((char)this.serialPort_0.ReadByte());
					while (!text3.Contains("OK\r") && !text3.Contains("?") && text3.Length < 20)
					{
						text3 += (char)this.serialPort_0.ReadByte();
					}
					this.serialPort_0.BaudRate = 250000;
					this.serialPort_0.ReadTimeout = 80;
					text3 = string.Concat((char)this.serialPort_0.ReadByte());
					while (!text3.Contains("\r") && text3.Length < 20)
					{
						text3 += (char)this.serialPort_0.ReadByte();
					}
				...
				byte[] array3 = this.method_38(this.byte_3);
	...
	// Token: 0x060004DE RID: 1246 RVA: 0x000906AC File Offset: 0x0008E8AC
	...
	// Token: 0x060004DF RID: 1247 RVA: 0x000907D0 File Offset: 0x0008E9D0
	...
	// Token: 0x060004E0 RID: 1248 RVA: 0x000546F4 File Offset: 0x000528F4
	...
	// Token: 0x060004E1 RID: 1249 RVA: 0x00054794 File Offset: 0x00052994
	...
	// Token: 0x060004E2 RID: 1250 RVA: 0x00018A1C File Offset: 0x00016C1C
	...
	// Token: 0x060004E3 RID: 1251 RVA: 0x00090A6C File Offset: 0x0008EC6C
	...
	// Token: 0x060004E4 RID: 1252 RVA: 0x00090AC8 File Offset: 0x0008ECC8
	...
	// Token: 0x060004E5 RID: 1253 RVA: 0x00090B80 File Offset: 0x0008ED80
	...
	// Token: 0x060004E6 RID: 1254 RVA: 0x00090DCC File Offset: 0x0008EFCC
	...
	// Token: 0x060004E7 RID: 1255 RVA: 0x0009107C File Offset: 0x0008F27C
	...
	// Token: 0x060004E8 RID: 1256 RVA: 0x00091210 File Offset: 0x0008F410
	...
	// Token: 0x060004E9 RID: 1257 RVA: 0x00091238 File Offset: 0x0008F438
	...
	// Token: 0x060004EA RID: 1258 RVA: 0x000917E8 File Offset: 0x0008F9E8
	...
	// Token: 0x060004EB RID: 1259 RVA: 0x0006288C File Offset: 0x00060A8C
	...
	// Token: 0x060004EC RID: 1260 RVA: 0x00062918 File Offset: 0x00060B18
	...
	// Token: 0x060004ED RID: 1261 RVA: 0x000918A4 File Offset: 0x0008FAA4
	...
	// Token: 0x060004EE RID: 1262 RVA: 0x0005E6E4 File Offset: 0x0005C8E4
	...
	// Token: 0x060004EF RID: 1263 RVA: 0x00091908 File Offset: 0x0008FB08
	...
	// Token: 0x060004F0 RID: 1264 RVA: 0x00091DB4 File Offset: 0x0008FFB4
